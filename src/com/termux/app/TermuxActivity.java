...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public void onCreate(Bundle bundle) {
                ...
                DialogUtils.textInput(TermuxActivity.this, R.string.session_new_named_title, null, R.string.session_new_named_positive_button,
                    new DialogUtils.TextSetListener() {
                        ...
                        public void onTextSet(String text) {
                            TermuxActivity.this.addNewSession(false, text);
                        }
                    }, R.string.new_session_failsafe, new DialogUtils.TextSetListener() {
                        @Override
                        public void onTextSet(String text) {
                            TermuxActivity.this.addNewSession(true, text);
                        }
                    }
                    , -1, null, null);
                return true;
        ...
        findViewById(R.id.toggle_keyboard_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                InputMethodManager imm = (InputMethodManager) TermuxActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        findViewById(R.id.toggle_keyboard_button).setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                TermuxActivity.this.toggleShowExtraKeys();
                return true;
            }
        });
    ...
    public void onServiceConnected(ComponentName componentName, IBinder service) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TermuxActivity.this.switchToSession(clickedSession);
                TermuxActivity.this.getDrawer().closeDrawers();
            }
        });
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TermuxActivity.this.renameSession(selectedSession);
                return true;
            }
        });
            ...
            if (mIsVisible) {
                TermuxInstaller.setupIfNeeded(TermuxActivity.this, new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            Bundle bundle = TermuxActivity.this.getIntent().getExtras();
                            boolean launchFailsafe = false;
                            if (bundle != null) {
                                launchFailsafe = bundle.getBoolean(TERMUX_FAILSAFE_SESSION_ACTION, false);
                            }
                            TermuxActivity.this.addNewSession(launchFailsafe, null);
    ...
    void showUrlSelection() {
        ...
        final AlertDialog dialog = new AlertDialog.Builder(TermuxActivity.this).setItems(urls, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface di, int which) {
                ...
                ClipboardManager clipboard = (ClipboardManager) TermuxActivity.this.getSystemService(Context.CLIPBOARD_SERVICE);
            ...
            public void onShow(DialogInterface di) {
                ...
                lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        try {
                            TermuxActivity.this.startActivity(i, null);
                        } catch (ActivityNotFoundException e) {
                            // If no applications match, Android displays a system message.
                            TermuxActivity.this.startActivity(Intent.createChooser(i, null));
                        }
                        return true;
                    }
                });
                    ...
                    new AlertDialog.Builder(this).setMessage(R.string.styling_not_installed)
                        .setPositiveButton(R.string.styling_install, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                TermuxActivity.this.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.termux.styling")));
                            }
